...
#define DISP_SS_PORT GPIOA
#define DISP_SS_PIN GPIO_PIN_15

#define DISP_DISP_PORT GPIOC
#define DISP_DISP_PIN GPIO_PIN_8

#define LED_ROW_1_PORT GPIOB
#define LED_ROW_1_PIN GPIO_PIN_15
#define LED_ROW_2_PORT GPIOC
...
#define LED_ROW_12_PIN GPIO_PIN_1
