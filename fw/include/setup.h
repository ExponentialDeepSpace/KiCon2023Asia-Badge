...
#define LED_SAO_TIM_DMA_CH DMA_CH4
#define LED_SAO_TIM_DMA_INT_GLB DMA_INT_GLB4
#define LED_SAO_TIM_DMA_INT_HTX DMA_INT_HTX4
#define LED_SAO_TIM_DMA_INT_TXC DMA_INT_TXC4
#define LED_SAO_TIM_DMA_INT_ERR DMA_INT_ERR4
#define LED_SAO_TIM_DMA_REMAP DMA_REMAP_TIM4_UP
#define LED_SAO_DMA_IRQHandler DMA_Channel4_IRQHandler
#define LED_SAO_TIM_IRQHandler TIM4_IRQHandler
// #define LED_SAO_USE_DMA
...
#define DISPLAY_SPI_DMA_CHANNEL DMA_CH5
#define DISPLAY_SPI_DMA_CHANNEL_REMAP DMA_REMAP_SPI1_TX

#define DISPLAY_DMA_INT_GLB DMA_INT_GLB5
#define DISPLAY_DMA_INT_TXC DMA_INT_TXC5
#define DISPLAY_DMA_INT_HTX DMA_INT_HTX5
#define DISPLAY_DMA_INT_ERR DMA_INT_ERR5

#define Display_DMA_IRQn DMA_Channel5_IRQn
#define Display_DMA_IRQHandler DMA_Channel5_IRQHandler
#define Display_SPI_IRQn SPI1_IRQn
#define Display_SPI_IRQHandler SPI1_IRQHandler

#define DISPLAY_SPI_DMA_INTERRUPT_PRIORITY_LEVEL (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY+2)
#define DISPLAY_SPI_INTERRUPT_PRIORITY_LEVEL (configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY+3)
